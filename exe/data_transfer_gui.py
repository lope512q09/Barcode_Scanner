...
with open('C:/Users/lope512q09/Desktop/Barcode_Scanner/employee_database/employee_database.csv', newline='') as employee_csv:
    reader = csv.DictReader(employee_csv)

    """Data Entry Program"""
    # Open data base using pandas data frame.
    filename = "C:/Users/lope512q09/Desktop/Barcode_Scanner/employee_database/employee_database.csv"
...
df.to_csv(r'C:/Users/lope512q09/Desktop/Barcode_Scanner/employee_database/employee_database.csv', index=False)
